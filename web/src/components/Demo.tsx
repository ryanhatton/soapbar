      ...
      <div className='relative w-full rounded-xl mt-12 bg-gray-900/5 p-4 ring-1 ring-inset ring-gray-900/10 lg:rounded-2xl'>
        <div className='flex justify-between items-center'>
          <div className='flex items-center gap-4'>
            <span className='inline-flex items-center rounded-md bg-teal-500 px-3 py-1 text-xs font-medium text-white ring-1 ring-inset ring-blue-400/20'>
              POST
            </span>
        ...
        <div className='relative flex flex-col sm:flex-row items-center gap-2 mt-6 h-full sm:h-9'>
          ...
          <Button
            disabled={isPending}
            className='h-9 w-full sm:w-fit bg-teal-500'
